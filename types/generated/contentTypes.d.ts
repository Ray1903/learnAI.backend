...
export interface ApiChatMessageChatMessage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    agent_name: Schema.Attribute.String;
    ...
    > &
      Schema.Attribute.Private;
    message_index: Schema.Attribute.Integer;
...
export interface ApiDocumentChunkDocumentChunk
  extends Struct.CollectionTypeSchema {
  collectionName: 'document_chunks';
  info: {
    displayName: 'document_chunk';
    pluralName: 'document-chunks';
    singularName: 'document-chunk';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    chunk_index: Schema.Attribute.Integer;
    content: Schema.Attribute.Text;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    document_student: Schema.Attribute.Relation<
      'manyToOne',
      'api::files-student.files-student'
    >;
    embedding: Schema.Attribute.Text;
    embedding_model: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'text-embedding-3-small'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::document-chunk.document-chunk'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiFilesStudentFilesStudent
  extends Struct.CollectionTypeSchema {
  collectionName: 'files_students';
  info: {
    displayName: 'document_student';
    pluralName: 'files-students';
    singularName: 'files-student';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    document_chunks: Schema.Attribute.Relation<
      'oneToMany',
      'api::document-chunk.document-chunk'
    >;
...
export interface ApiStudentStudent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    document_students: Schema.Attribute.Relation<
      'oneToMany',
      'api::files-student.files-student'
    >;
    first_name: Schema.Attribute.String;
    gender: Schema.Attribute.Enumeration<['male', 'female', 'other']>;
    instituion: Schema.Attribute.Relation<
      'oneToOne',
...
export interface ApiUniversityUniversity extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    study_preferences: Schema.Attribute.JSON;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::document-chunk.document-chunk': ApiDocumentChunkDocumentChunk;
      'api::files-student.files-student': ApiFilesStudentFilesStudent;
